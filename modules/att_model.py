...
class AttModel(CaptionModel):
    ...
    def get_logprobs_state(self, it, fc_feats, att_feats, p_att_feats, att_masks, gram,gram_masks,nodes,node_masks, state,output_logsoftmax=1):
        # 'it' contains a word index
        xt = self.embed(it)
        output, state = self.core(xt, fc_feats, att_feats, p_att_feats, state, att_masks,gram,gram_masks,nodes,node_masks)
    ...
    def _sample_beam(self, topic_features,node_embeddings,fc_feats, att_feats, att_masks=None, opt={}):
        ...
        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks = self._prepare_feature(fc_feats, att_feats, att_masks,topic_features,node_embeddings[1],node_embeddings[0])
        ...
        logprobs, state = self.get_logprobs_state(it, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks, state)

        p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks  = utils.repeat_tensors(beam_size,
                                                                                  [p_fc_feats, p_att_feats,
                                                                                   pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks ]
                                                                                  )

        self.done_beams = self.beam_search(state, logprobs, p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks, opt=opt)
    ...
    def _sample(self, fc_feats, att_feats,topic_features,node_embeddings, att_masks=None):
        ...
        if beam_size > 1 and sample_method in ['greedy', 'beam_search']:
            return self._sample_beam(topic_features,node_embeddings,fc_feats, att_feats, att_masks, opt)
        if group_size > 1:
        ...
        if sample_n > 1:
            p_fc_feats, p_att_feats, pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks = utils.repeat_tensors(sample_n,
                                                                                      [p_fc_feats, p_att_feats,
                                                                                       pp_att_feats, p_att_masks,gram,gram_masks,nodes,node_masks]
                                                                                      )
