...
def parse_agrs():
    ...
    # Data input settings
    parser.add_argument('--image_dir', type=str, default='path of files/', help='the path to the directory containing the data.')
    parser.add_argument('path of annotation.json', help='the path to the directory containing the data.')
                                                                                                                                                                    #pos_new_annotation.json
